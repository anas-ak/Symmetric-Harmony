...
// selected from array of images from below on page load
var images = [
    ...
    'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/4bf03b16163257.56039b4c63519.jpg',
    'https://i.pinimg.com/originals/78/9e/4e/789e4e4583029145688cf3ed7d43ae13.png'
]

// Write a function that returns a random image
var randomImg = function() {
    
    // len = length of [images] array
    var len = images.length

    // generate a random number multiplied by len
    var randomConstant = Math.floor(Math.random() * len)

    // return the image at index[randomConstant]
    return images[randomConstant]
}
